# MathQuest — Full Story Script

> **Setting:** The Kingdom of Numeria — a magical land where math keeps everything in balance.
> **Premise:** The sorcerer Zalthor has stolen the eight Numbers of Power — magical crystals that keep Numeria stable. Without them, bridges crumble, rivers flow backwards, and bakeries can't count pies. A young hero must travel across 8 worlds, solve math challenges, defeat guardians, and recover the crystals.
...
|---|---|---|
| **Professor Hoot** 🦉 | Mentor | Elderly great horned owl. Wise, warm, grandfatherly. Sends magical letters. |
| **Pip** 🦊 | Companion | Young red-orange fox. Brave, funny, clumsy, always hungry. Comic relief + heart. |
| **Zalthor** | Villain (unseen) | Evil sorcerer. Stole the crystals. Referenced but never directly appears. |
| **Numblet** 🐲 | World 0 Boss | Baby dragon. Cute but fierce. |
| **Twig** | World 0 Mini-Boss | Tiny stick sprite with acorn helmet. |
| **Syllabuzz** 💎 | World 1 Boss | Crystal golem. Purple/blue crystals. |
| **Glimmer** | World 1 Mini-Boss | Crystal bat. Confused and sparkly. |
| **Fablewing** 🦋 | World 2 Boss | Giant magical butterfly. Regal. |
| **Petalwhirl** | World 2 Mini-Boss | Chubby flower fairy. |
| **Calculon** ⚔️ | World 3 Boss | Armored dragon. Iron blacksmith warrior. |
| **Cinder** | World 3 Mini-Boss | Grumpy fire imp. |
| **Vowelstrike** 🐍 | World 4 Boss | Massive swamp serpent. |
| **Boggle** | World 4 Mini-Boss | Ugly swamp toad. |
| **Riddle Sphinx** 🗿 | World 5 Boss | Ancient stone sphinx. |
| **Rune** | World 5 Mini-Boss | Floating stone mask. |
| **The Lexicon** 📖 | World 6 Boss | Giant sentient floating book. |
| **Zephyr** | World 6 Mini-Boss | Cloud dragon. |
| **Archimedes** 🐉 | World 7 Boss | Colossal final dragon. The ultimate guardian. |
| **Ember** | World 7 Mini-Boss | Baby phoenix. |
...
**Math Focus:** Addition, 0–10
**Crystal:** The Addition Crystal (green)
...
#### SCENE: Mini-Boss Intro (Stage 5 — Twig)
...
#### SCENE: Boss Intro (Stage 8 — Numblet)
...
## ACT 2 — GROWING STRONGER

---

### WORLD 1: CRYSTAL CAVES
**Math Focus:** Addition + Subtraction, 0–20
**Crystal:** The Subtraction Crystal (blue)
...
#### SCENE: Mini-Boss Intro (Stage 5 — Glimmer)
...
#### SCENE: Boss Intro (Stage 8 — Syllabuzz)
...
**Math Focus:** Addition + Subtraction, 10–100
**Crystal:** The Place Value Crystal (golden)
...
#### SCENE: Mini-Boss Intro (Stage 5 — Petalwhirl)
...
#### SCENE: Boss Intro (Stage 8 — Fablewing)
...
**Math Focus:** Multiplication, tables 1–5
**Crystal:** The Multiplication Crystal (orange)
...
#### SCENE: Boss Intro (Stage 8 — Calculon)
...
**Math Focus:** Division, tables 1–5
**Crystal:** The Division Crystal (purple)
...
#### SCENE: Boss Intro (Stage 8 — Vowelstrike)
...
**Math Focus:** Multiply + Divide, tables 1–10
**Crystal:** The Operations Crystal (rainbow)
...
#### SCENE: Boss Intro (Stage 8 — Riddle Sphinx)
...
## ACT 5 — THE FINAL BATTLES

---

### WORLD 6: SKY CITADEL
**Math Focus:** All 4 operations, 0–500
**Crystal:** The Mastery Crystal (white)
...
#### SCENE: Boss Intro (Stage 8 — The Lexicon)
...
**Math Focus:** All 4 operations, 0–10,000
**Crystal:** The Crystal of Champions
...
#### SCENE: Final Boss Intro (Stage 8 — Archimedes the Eternal)

**ARCHIMEDES THE ETERNAL:**
...
| # | World | Crystal Name | Color | Math Skill |
|---|---|---|---|---|
| 1 | Emerald Forest | Addition Crystal | Green | Addition, 0–10 |
| 2 | Crystal Caves | Subtraction Crystal | Blue | Add + Subtract, 0–20 |
| 3 | Mystic Meadows | Place Value Crystal | Gold | Add + Subtract, 10–100 |
| 4 | Ironforge Mountains | Multiplication Crystal | Orange | Multiplication, ×1–5 |
| 5 | Shadow Swamp | Division Crystal | Purple | Division, ÷1–5 |
| 6 | Enchanted Ruins | Operations Crystal | Rainbow | Multiply + Divide, ×1–10 |
| 7 | Sky Citadel | Mastery Crystal | White | All 4 ops, 0–500 |
| 8 | Dragon's Peak | Crystal of Champions | Prismatic | All 4 ops, 0–10,000 |
